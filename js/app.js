(() => {
    ...
    (() => {
        ...
        function menuInitTop() {
            if (document.querySelector(".icon-menu-top")) document.addEventListener("click", (function(e) {
        ...
        function menuInitLeft() {
            if (document.querySelector(".icon-menu-left")) document.addEventListener("click", (function(e) {
